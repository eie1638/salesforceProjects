...
{ 
     ...
     { 
              ...
              for(String str : detailSobjectMap.keyset()) 
               { 
                    ...
                    { 
                         ...
                         { 
                             if(lstWoLines[i].SVMXC__Line_Status__c == 'Completed') 
                             {
                                lstWoLines[i].SVMXC__Closed_By__c = userinfo.getuserid(); 
                             }
                         } 
                         update lstWoLines; 
         ...
         pagedata = def.SFM_Page_BuildResponse(request, headerSobj, lstWoLines); 
